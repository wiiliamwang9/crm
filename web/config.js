...
window.GlobalApiConfig = {
    ...
    ENDPOINTS: {
        ...
        CUSTOMERS: {
            ...
            // 客户偏好管理
            PREFERENCES: {
                LIST: '/api/v1/customers/{id}/preferences',
                CREATE: '/api/v1/customers/{id}/preferences',
                UPDATE: '/api/v1/customers/{id}/preferences/{preference_id}',
                DELETE: '/api/v1/customers/{id}/preferences/{preference_id}'
            }
        },
        ...
        // 跟进记录相关API
        FOLLOW_UP_RECORDS: {
            LIST: '/api/v1/follow-up-records',
            CREATE: '/api/v1/follow-up-records',
            DETAIL: '/api/v1/follow-up-records/{id}',
            UPDATE: '/api/v1/follow-up-records/{id}',
        ...
        // 标签维度相关API
        TAG_DIMENSIONS: {
            LIST: '/api/v1/tag-dimensions',
            CREATE: '/api/v1/tag-dimensions'
        },
...
// 向后兼容：设置window.baseUrl
window.baseUrl = window.GlobalApiConfig.BASE_URL;
